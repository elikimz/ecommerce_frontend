...
const AdminOrderManagePage: React.FC = () => {
  ...
  return (
    <div className="p-6">
      {/* ✅ SEO Meta Tags */}
      <Helmet>
        <title>Admin – Order Management | Smart Indoor Decors</title>
        <meta
          name="description"
          content="Admin dashboard to manage all customer orders on Smart Indoor Decors. View, update, and delete customer orders efficiently."
        />
        <meta name="robots" content="noindex, nofollow" />
        <meta
          property="og:title"
          content="Admin – Order Management | Smart Indoor Decors"
        />
        <meta
          property="og:description"
          content="Efficiently manage orders in your eCommerce store. View order details and update shipping and payment status."
        />
