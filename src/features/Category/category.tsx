...
const CategoryPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <Helmet>
        <title>Category Management | Admin | Smart Indoor Decors</title>
        <meta
          name="description"
          content="Manage product categories for Smart Indoor Decors. Add, update, or delete product categories for better product organization."
        />
        <meta
          name="keywords"
          content="admin, category management, ecommerce dashboard, product categories, smart indoor decors admin"
        />
        <link
          rel="canonical"
          href="https://ecommerce-frontend-blush-two.vercel.app/admin/categories"
        />
        ...
        <meta
          property="og:url"
          content="https://ecommerce-frontend-blush-two.vercel.app/admin/categories"
        />
        <meta
          property="og:title"
          content="Category Management | Smart Indoor Decors"
        />
        <meta
          property="og:description"
          content="Organize and manage product categories in the Smart Indoor Decors platform."
        />
        <meta
          property="og:image"
          content="https://ecommerce-frontend-blush-two.vercel.app/og-categories.jpg"
        />
        ...
        <meta
          ...
          content="Easily manage all product categories in your ecommerce store."
        />
        <meta
          name="twitter:image"
          content="https://ecommerce-frontend-blush-two.vercel.app/og-categories.jpg"
